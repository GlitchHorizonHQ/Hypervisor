...
namespace Hypervisor.References
{
    public static class ReferenceScanner
    {
        ...
        /// <summary>
        /// Initializes the scanner and loads all assmeblies found under the given base path recursively
        /// </summary>
        ...
        private static void TryLoadAssembly(string filePath)
        {
            ...
            {
                MelonLogger.Warning($"ReferenceScanner unexpected error for '{filePath}': {expection.Message}");
            }
        }
    }
}
